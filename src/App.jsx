            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  {[{ id: 'light', label: tu('themeLight') }, { id: 'dark', label: tu('themeDark') }, { id: 'glass', label: tu('themeGlass') }, { id: 'hacker', label: tu('themeHacker') }].map(thm => (
